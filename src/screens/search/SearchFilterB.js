...
export default class SearchFilterB extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      menu: [
        {title: 'Dry Fruit', picked: false},
        {title: 'Pickles', picked: false},
        {title: 'Powders', picked: true},
        {title: 'Sweets', picked: false},
        {title: 'Namkeen', picked: false},
      ],
      cuisine: [
        {title: 'Chicken Pickle', picked: true},
        {title: 'Jantukulu', picked: false},
        {title: 'Muttom Pickle', picked: false},
        {title: 'Khaju', picked: false},
        {title: 'Karma Podi', picked: false},
        {title: 'Dry Fruit Laddu', picked: false},
        {title: 'Maagay', picked: false},
        {title: 'Almond', picked: false},
      ],
    };
  }
